...
- Do NOT blindly copy findings. Papers train on different data, at different scales, with different budgets. Adapt the idea to this setup (single GPU, 5-minute budget, ~50M params, BPB metric).
